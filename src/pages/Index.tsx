      ...
      <section className="container mx-auto px-4 pt-4">
        <div className="relative h-[85vh] rounded-3xl overflow-hidden">
          ...
          <button
            ...
            className="absolute left-4 top-1/2 -translate-y-1/2 z-20 text-white rounded-full p-2.5 backdrop-blur-sm transition-all duration-300 hover:scale-110 shadow-lg"
          ...
          <button
            ...
            className="absolute right-4 top-1/2 -translate-y-1/2 z-20 text-white rounded-full p-2.5 backdrop-blur-sm transition-all duration-300 hover:scale-110 shadow-lg"
            style={{ background: 'var(--gradient-primary)' }}
          >
